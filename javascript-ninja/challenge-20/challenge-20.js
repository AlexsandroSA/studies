(function( win, doc ) {
    ...
    */
    ...
    o e-mail que foi entrado no campo de "Email" por parâmetro. (A função `isValidEmail` será criada logo abaixo).
    ...
    */
    $button.addEventListener( 'click', function(event) {
        ...
        var confirmSend = 'Tem certeza que deseja enviar o formulário?';
