(function() {
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/g, 'Alexsandro Silva Alves') );
    ...
    */
    ...
    console.log( text.replace( /[0-9]/g, '-' ) ); // or /\d/g
    ...
    */
    ...
    console.log( text.replace( /a/gi, 4) ); // or /A|a/g
    ...
    */
    ...
    console.log(
        text.replace( /O Centauro de Luvas/g, function( textMath ) {
            return textMath.toUpperCase();
        })
    );
    ...
    */
    ...
    function showMothByNumber( nameOfMonth ) {
        return 'O mês de ' + nameOfMonth + ' é representado pelo número ' + getMonthNumber(nameOfMonth) + '.';
    }

    console.log( showMothByNumber( 'março' ) );
    console.log( showMothByNumber( 'setembro' ) );
    console.log( showMothByNumber( 'dezembro' ) );
